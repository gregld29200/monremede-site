...
/**
 * BookContentSection - Colorful Chapter Cards
 * Vibrant colored cards in a grid with book mockup centered
 */
...
export function BookContentSection() {
  return (
    <section id="decouvrir" className="min-h-screen bg-cream-warm relative overflow-hidden py-20 lg:py-32">
      {/* Background pattern */}
